  ...
  const faqs = [
    {
      ...
      answer: 'Để mua tài khoản game, bạn cần: 1) Đăng ký tài khoản trên website, 2) Nạp tiền vào tài khoản, 3) Chọn tài khoản game muốn mua và nhấn "Mua ngay", 4) Xác nhận thanh toán. Thông tin tài khoản sẽ được gửi qua email ngay sau khi thanh toán thành công.'
    },
    {
      id: 2,
      category: 'account',
      question: 'Tôi có thể đổi trả tài khoản không?',
      answer: 'Chúng tôi có chính sách bảo hành 30 ngày cho tất cả tài khoản. Nếu tài khoản có vấn đề về đăng nhập hoặc không đúng như mô tả, vui lòng liên hệ CSKH trong vòng 30 ngày để được hỗ trợ đổi tài khoản hoặc hoàn tiền.'
    },
    {
      id: 3,
      category: 'payment',
      question: 'Những phương thức thanh toán nào được hỗ trợ?',
      answer: 'Chúng tôi hỗ trợ nhiều phương thức thanh toán: Ví điện tử (MoMo, ZaloPay), Chuyển khoản ngân hàng, Thẻ ATM/Credit Card, và Nạp thẻ cào điện thoại.'
    },
    {
      id: 4,
      category: 'payment',
      question: 'Mất bao lâu để tiền được cập nhật vào tài khoản?',
      answer: 'Thời gian cập nhật tiền phụ thuộc vào phương thức thanh toán: Ví điện tử (1-5 phút), Chuyển khoản ngân hàng (5-15 phút), Thẻ cào (15-30 phút). Nếu sau thời gian trên tiền chưa được cập nhật, vui lòng liên hệ CSKH.'
    },
    {
      id: 5,
      category: 'security',
      question: 'Thông tin cá nhân của tôi có an toàn không?',
      answer: 'Chúng tôi cam kết bảo mật 100% thông tin cá nhân của bạn. Mọi dữ liệu đều được mã hóa SSL và không chia sẻ cho bên thứ ba. Chúng tôi tuân thủ nghiêm ngặt các quy định về bảo vệ dữ liệu cá nhân.'
    },
    {
      id: 6,
      category: 'security',
      question: 'Làm sao để bảo vệ tài khoản sau khi mua?',
      answer: 'Sau khi mua tài khoản, bạn nên: 1) Đổi mật khẩu ngay lập tức, 2) Liên kết email/số điện thoại của bạn, 3) Bật xác thực 2 yếu tố nếu có, 4) Không chia sẻ thông tin tài khoản với người khác, 5) Không vi phạm điều khoản của game.'
    },
    {
      id: 7,
      category: 'account',
      question: 'Tôi muốn bán tài khoản game, phải làm sao?',
      answer: 'Để bán tài khoản game, vào mục "Đăng bán tài khoản", điền đầy đủ thông tin và tải lên ảnh chụp màn hình. Tài khoản sẽ được kiểm duyệt trong 24h. Phí hoa hồng là 5% giá trị giao dịch.'
    },
    {
      id: 8,
      category: 'payment',
      question: 'Có thể rút tiền về tài khoản ngân hàng không?',
      answer: 'Có, bạn có thể yêu cầu rút tiền về tài khoản ngân hàng. Số tiền tối thiểu để rút là 100,000đ. Thời gian xử lý là 1-3 ngày làm việc. Phí rút tiền là 5,000đ/giao dịch.'
    }
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-gradient-to-r from-[#0D4D8B] to-[#F5A65B] text-white rounded-2xl p-8 mt-12 text-center">
          ...
          <p className="text-blue-100 mb-6">
            Đội ngũ CSKH của chúng tôi luôn sẵn sàng giúp đỡ bạn
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:support@gameaccount.vn"
